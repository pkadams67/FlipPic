...
extension UIView {
    ...
    func leftBorder(littleImage: Bool = false) -> CALayer {
        var lineWidth = EditViewController.lineWidth
    ...
    private var topLeftToBottomRightBorder: CAShapeLayer {
        ...
        layer.lineWidth = EditViewController.lineWidth
    ...
    func removeBorders() {
        print("Before: \(String(describing: layer.sublayers?.count))")
        ...
        print("After: \(String(describing: layer.sublayers?.count))")
    }
    
    func updateBorderForLayout(layout: SubLayout) {
        print(layer.sublayers?.count as Any)
